        ...
        const projects = {
            all: [
                ...
                },
                {
                    ...
                    description: "KeyBoard Short Keys for Windows and Mac systems",
                    tags: ["HTML", "CSS", "JavaScript", "Utility"],
                    image: "https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/MXCL3?wid=1144&hei=1144&fmt=jpeg&qlt=90&.v=S1pkeVJDY2FBQ0dISk1WYXJ4V1Yxd2tuVHYzMERCZURia3c5SzJFOTlPam52L09kbzNiSStKOHg1RWFmMk9ZeHNPTTVzYTczc3ZWbTJwM0wxQ1TUSEE",
                    links: [
                        { text: "View Live", url: "https://himanshufullstackdeveloper.github.io/keyboardshortcut/" }
                    ]
                },
                {
                    title: "StyleShop",
            ...
            nodejs: [
                {
                    ...
                    image: "https://miro.medium.com/v2/resize:fit:1400/1*f7ztMaMM0etsFHpEfkdiwA.png",
                    links: [
                        { text: "View Code", url: "#" },
                        { text: "API Docs", url: "#" }
                    ]
            ...
            dbms: [
                {
                    ...
                    image: "https://www.sqlgate.com/wp-content/uploads/2018/03/blog_schema_01.png",
                    links: [
                        { text: "View Code", url: "#" },
                        { text: "Try Online", url: "#" }
                    ]
            ...
            reactjs: [
                {
                    ...
                    image: "https://miro.medium.com/v2/resize:fit:1400/1*XdEqNm6V9w9nHh-bp-qnKQ.png",
                    links: [
                        { text: "View Code", url: "#" },
                        { text: "Storybook", url: "#" }
                    ]
            ...
            assignment: [
                {
                    ...
                    image: "https://miro.medium.com/v2/resize:fit:1400/1*HfvWcJeOKZ8w-WlNqm2uyA.gif",
                    links: [
                        { text: "View Code", url: "#" },
                        { text: "Demo", url: "#" }
                    ]
            ...
            languages: [
                {
                    ...
                    image: "https://cdn.educba.com/academy/wp-content/uploads/2020/01/Programming-Languages.jpg",
                    links: [
                        { text: "View Code", url: "#" },
                        { text: "Try Tool", url: "#" }
                    ]
